...
export const { version, defaultOptions, tokenTypes, errors, ast, lex, parse, write, end } = _lpExports;
export const LuaSyntaxError = _lpExports.SyntaxError;
export default _lpExports;